...
Мы можем использовать целые числа в диапозоне от -2<suo>31 до 2<sup>31-1, так как нет практического смысла рассматривать числа, превосходящие по модулю 2<sup>31.
