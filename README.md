...
Мы можем использовать целые числа в диапазоне от -2<sup>31</sup> до 2<sup>31</sup>-1, так как нет практического смысла рассматривать числа, превосходящие по модулю 2<sup>31.
